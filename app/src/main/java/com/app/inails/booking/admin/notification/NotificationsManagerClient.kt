...
class NotificationsManagerClient(private val mContext: Context) {

    val id: Int
        get() = c.incrementAndGet()

    fun defaultNotify(cloudMessage: FireBaseCloudMessageClient) {
        val pendingIntent = ClientHomeActivity.getPendingIntent(mContext, cloudMessage)
