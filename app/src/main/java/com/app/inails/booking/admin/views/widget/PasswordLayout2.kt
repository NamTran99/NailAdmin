...
class PasswordLayout2 @JvmOverloads constructor(
    ...
    init {
        ...
        context.loadAttrs(attrs, R.styleable.PasswordLayout2) {
            mIconColor = it.getColor(R.styleable.PasswordLayout2_iconColorr, Color.BLACK)
        }
    }
    ...
    private fun addToggleView() {
        mIcon = ImageButton(context).also { view ->
            ...
            view.setBackgroundResource(context.getAppResourceId(com.bumptech.glide.R.attr.selectableItemBackgroundBorderless))
