...
import com.app.inails.booking.admin.databinding.ItemStaffBinding
...
class StaffAdapter(view: RecyclerView) :
    SimpleRecyclerAdapter<IStaff, ItemStaffBinding>(view) {
    ...
    override fun onCreateBinding(parent: ViewGroup): ItemStaffBinding {
        return parent.bindingOf(ItemStaffBinding::inflate)
    }
